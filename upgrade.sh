...
UART_POWER_PERCENTAGE=$(get_cfg UART_POWER_PERCENTAGE)
UART_POWER_PERCENTAGE=${UART_POWER_PERCENTAGE:-100,100,100,100,100,100,100,100,100,0,100,100,100,100,100,100,100,100,100,0}
...
cat > $NEW_CONF << EOF
[AFRM]
MONITOR_PLATFORM=SOLARMAN# 平台名称
...
UART_POWER_PERCENTAGE=${UART_POWER_PERCENTAGE}#
